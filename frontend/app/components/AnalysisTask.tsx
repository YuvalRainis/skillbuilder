...
import { getTaskContent, evaluateAnalysis } from "@/lib/api";
...
export default function AnalysisTask({ sessionId, taskTitle, taskId, onTaskComplete }: AnalysisTaskProps) {
  ...
  const handleEvaluate = async () => {
    ...
    try {
      ...
      const result = await evaluateAnalysis(sessionId, taskTitle, content.question, answer);
  ...
  return (
    <div style={{ padding: "40px", maxWidth: "900px", margin: "0 auto" }}>
      ...
      <div style={{
        ...
        <h3 style={{ margin: "0 0 16px 0", color: "#764ba2", fontSize: 18 }}>Conversation Transcript</h3>
        <div style={{
          background: "#fff",
          padding: "16px",
          borderRadius: "8px",
      ...
      <div style={{
        ...
        <p style={{ margin: 0, fontSize: 16, color: "#333" }}>{content.question}</p>
      </div>
